...
function CloseIcon(props) {
  return (() => {
    const _el$ = _tmpl$$a();
    effect(_$p => style(_el$, props.style ? {
      overflow: 'visible',
      'font-size': '22px',
      ...props.style
    } : {
...
function LeftIcon(props) {
  return (() => {
    ...
    effect(_$p => style(_el$2, props.style ? {
      overflow: 'visible',
      ...props.style
    } : {
      overflow: 'visible'
...
function LogoIcon(props) {
  return (() => {
    ...
    effect(_$p => style(_el$3, props.style ? {
      ...props.style
    } : {}, _$p));
    return _el$3;
  })();
...
const openAlert = async config => {
  ...
  if (!isOpen$1()) {
    ...
    dispose$1 = render(() => (() => {
      ...
      insert(_el$, createComponent(AlertResize, {}), null);
      insert(_el$, (() => {
            ...
            return (() => {
              ...
              insert(_el$2, (() => {
                ...
                return () => _c$3() && (() => {
                  const _el$6 = _tmpl$$1();
                  insert(_el$6, (() => {
                    const _c$5 = memo(() => !!(!isMobile() && isOnline && currentWallet()?.types.includes('web')));
                  ...
                  insert(_el$6, (() => {
                    const _c$6 = memo(() => !!(!isMobile() && currentWallet()?.types.includes('extension')));
                    return () => _c$6() && createComponent(Info, {
                      border: true,
                      get title() {
                        return memo(() => !!hasExtension())() ? `Use Browser Extension` : `Install ${currentWallet()?.name} Wallet`;
                      },
                      get description() {
                        return memo(() => !!hasExtension())() ? `Please connect below to use your ${currentWallet()?.name} Wallet browser extension.` : `To connect your ${currentWallet()?.name} Wallet, install the browser extension.`;
                      },
                      get buttons() {
                        return hasExtension() ? [{
                          label: 'Connect now',
                  ...
                  insert(_el$6, (() => {
                    const _c$7 = memo(() => !!(!isMobile() && currentWallet()?.types.includes('desktop')));
                    return () => _c$7() && createComponent(Info, {
                      border: true,
                  ...
                  insert(_el$6, (() => {
                    const _c$8 = memo(() => !!(!isMobile() && codeQR().length > 0 && currentWallet()?.types.includes('ios') && currentWallet()?.types.length > 1));
                  ...
                  insert(_el$6, (() => {
                    const _c$9 = memo(() => !!(!isMobile() && codeQR().length > 0 && currentWallet()?.types.includes('ios') && currentWallet()?.types.length <= 1));
                  ...
                  insert(_el$6, (() => {
                    const _c$10 = memo(() => !!(isMobile() && codeQR().length > 0));
                    return () => _c$10() && createComponent(QR, {
                      get isWalletConnect() {
                        return currentWallet()?.supportedInteractionStandards?.includes('wallet_connect') || false;
                      },
                      isMobile: true,
...
delegateEvents(["mousedown", "click", "dblclick"]);
...
export { Pairing, closeAlerts, closeToast, getColorMode, getDesktopList, getExtensionList, getWebList, getiOSList, isBrowser, isDesktop, isMobile, isMobileOS, openAlert, openToast, setColorMode, setDesktopList, setExtensionList, setWebList, setiOSList };
