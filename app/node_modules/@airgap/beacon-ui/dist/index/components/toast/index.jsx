...
const Toast = (props) => {
    ...
    return (<div style={{ left: `${divPosition().x}px`, top: `${divPosition().y}px` }} class={props.open ? 'toast-wrapper-show' : 'toast-wrapper-hide'} onMouseDown={onMouseDownHandler} onClick={onClickHandler} onDblClick={onClickHandler}>
