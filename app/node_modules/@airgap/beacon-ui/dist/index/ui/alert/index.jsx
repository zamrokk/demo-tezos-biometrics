...
import { arrangeTopWallets, mergeWallets, OSLink, parseWallets } from '../../utils/wallets';
        ...
        dispose = render(() => (<div class={`theme__${colorMode}`}>
          ...
          {config.pairingPayload && (<Alert loading={isLoading()} open={isOpen()} showMore={showMoreContent()} content={<div>
                  {currentInfo() === 'install' && (<div style={currentInfo() === 'install' || currentInfo() === 'qr'
                      ...
                      {!isMobile() && isOnline && currentWallet()?.types.includes('web') && (<Info border title={'Open wallet in a new tab'} description={`Please connect below to use ${currentWallet()?.name}`} buttons={[
                                {
                                    label: 'Connect now',
                                    type: 'primary',
                      ...
                      {!isMobile() && currentWallet()?.types.includes('extension') && (<Info border title={hasExtension()
                                ...
                                : `To connect your ${currentWallet()
                                    ?.name} Wallet, install the browser extension.`} buttons={hasExtension()
                                ? [
                                    {
                                        label: 'Connect now',
                                        type: 'primary',
                  ...
                  <div style={currentInfo() === 'wallets'
                    ...
                    <Wallets wallets={walletList().slice(-(walletList().length - (isMobile() ? 3 : 4)))} isMobile={isMobile()} onClickWallet={handleClickWallet} onClickOther={handleClickOther}/>
                  </div>
                  ...
                  <div style={currentInfo() !== 'install' &&
                    ...
                    <TopWallets wallets={isMobile() ? walletList().slice(0, 3) : walletList().slice(0, 4)} isMobile={isMobile()} onClickWallet={handleClickWallet} onClickLearnMore={handleClickLearnMore} otherWallets={isMobile()
                        ? {
                            images: [
                                walletList()[3].image,
                                walletList()[4].image,
